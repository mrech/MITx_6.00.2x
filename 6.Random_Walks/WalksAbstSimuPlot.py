...
class ColdDrunk(Drunk):
    def takeStep(self):
        stepChoices = [(0.0, 0.9), (0.0, -1.0), (1.0, 0.0), (-1.0, 0.0)]
        return random.choice(stepChoices)

# Walks Simulation: hierarchy construction from simplistic to more complicated
...
# Print status of the simulations
...
def plotLocs(drunkKinds, numSteps, numTrials):
    ...
    for dClass in drunkKinds:
        ...
        xVals = pylab.array(xVals) # useful to calculate the absolute values
